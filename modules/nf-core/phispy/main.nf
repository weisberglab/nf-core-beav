process PHISPY {
    ...
    output:
    tuple val(meta), path("${meta.id}_phispy.tsv")                     , emit: coordinates
    tuple val(meta), path("${meta.id}_phispy.gb*")                     , emit: gbk
    tuple val(meta), path("${meta.id}_phispy.log")                     , emit: log
    tuple val(meta), path("${meta.id}_phispy_prophage_information.tsv"), optional:true, emit: information
    tuple val(meta), path("${meta.id}_phispy_bacteria.fasta")          , optional:true, emit: bacteria_fasta
    tuple val(meta), path("${meta.id}_phispy_bacteria.gbk")            , optional:true, emit: bacteria_gbk
    tuple val(meta), path("${meta.id}_phispy_phage.fasta")             , optional:true, emit: phage_fasta
    tuple val(meta), path("${meta.id}_phispy_phage.gbk")               , optional:true, emit: phage_gbk
    tuple val(meta), path("${meta.id}_phispy_prophage.gff3")           , optional:true, emit: prophage_gff
    tuple val(meta), path("${meta.id}_phispy_prophage.tbl")            , optional:true, emit: prophage_tbl
    tuple val(meta), path("${meta.id}_phispy_prophage.tsv")            , optional:true, emit: prophage_tsv
    ...
    prefix = task.ext.prefix ?: "${meta.id}_phispy"
